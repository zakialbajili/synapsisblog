    ...
    <>
      ...
      <LayoutPage>
        <div className="flex flex-col h-full lg:flex-row">
          <div className="w-full lg:w-[70%] h-full shadow-md border-r-[1px] border-border/50">
            {detailUser && (
              <div className="flex gap-5 border-b-[1px] border-border/50 p-5">
                <div className="rounded-full h-[100px] w-[100px] bg-lightGray/50">
            ...
            {listBlog && listBlog.length > 0 ? 
                (
                    ...
                    <div className="flex h-full items-center justify-center">
                        <p className="text-white font-semibold text-lg text-center">Data tidak ditemukan</p>
                    </div>
                )
            }
          </div>
